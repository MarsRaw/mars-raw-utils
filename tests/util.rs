...
fn test_string_is_valid_f32() {
    ...
    assert!(!util::string_is_valid_f32("fdsgfgdf"));
    assert!(!util::string_is_valid_f32("1.04f"));
}
...
fn test_string_is_valid_i32() {
    ...
    assert!(util::string_is_valid_i32("-1"));
    assert!(util::string_is_valid_i32("+1"));
    assert!(!util::string_is_valid_i32("1l"));
    assert!(!util::string_is_valid_i32("dfsuidhfiusdh"));
}
